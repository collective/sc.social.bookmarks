...
class SocialBookmarksTest(unittest.TestCase):
    ...
    def test_controlpanel_view_is_protected(self):
        ...
        logout()
        self.assertRaises(
            Unauthorized, self.portal.restrictedTraverse, "@@bookmarks-providers"
        )
    ...
    def test_controlpanel_removed_on_uninstall(self):
        ...
        self.assertTrue(
            "socialbookmarks" not in actions, "control panel was not removed"
        )
...
class RegistryTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.settings = self.registry.forInterface(IProvidersSchema, prefix=self.prefix)
        setRoles(self.portal, TEST_USER_ID, ["Manager"])
