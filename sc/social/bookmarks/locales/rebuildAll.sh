...
i18ndude rebuild-pot --pot sc.social.bookmarks.pot --create sc.social.bookmarks --merge manual.pot ../*

# finally, update the po files
i18ndude sync --pot sc.social.bookmarks.pot  `find . -iregex '.*\.po$'|grep -v plone`
